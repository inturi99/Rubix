...
var v_17932 = this$.pop();
if(cljs.core.truth_((function (){var G__17931 = v_17932;
return (keep_QMARK_.cljs$core$IFn$_invoke$arity$1 ? keep_QMARK_.cljs$core$IFn$_invoke$arity$1(G__17931) : keep_QMARK_.call(null,G__17931));
})())){
this$.unshift(v_17932);
} else {
}
...
return cljs.core._write(writer__4887__auto__,"cljs.core.async.impl.buffers/RingBuffer");
});
...
return cljs.core._write(writer__4887__auto__,"cljs.core.async.impl.buffers/FixedBuffer");
});
...
return cljs.core._write(writer__4887__auto__,"cljs.core.async.impl.buffers/DroppingBuffer");
});
...
return cljs.core._write(writer__4887__auto__,"cljs.core.async.impl.buffers/SlidingBuffer");
});
