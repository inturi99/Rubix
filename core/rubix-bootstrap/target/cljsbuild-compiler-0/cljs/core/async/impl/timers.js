...
return cljs.core._write(writer__4887__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var i_17789 = (0);
while(true){
if((i_17789 < arr.length)){
(arr[i_17789] = null);

var G__17790 = (i_17789 + (1));
i_17789 = G__17790;
continue;
} else {
}
...
var i_17801 = (self__.level + (1));
while(true){
if((i_17801 <= (new_level + (1)))){
(update[i_17801] = self__.header);
...
var i_17803 = (0);
while(true){
if((i_17803 <= self__.level)){
var links_17804 = (update[i_17803]).forward;
if(((links_17804[i_17803]) === x__$1)){
(links_17804[i_17803] = (x__$1.forward[i_17803]));

var G__17805 = (i_17803 + (1));
i_17803 = G__17805;
continue;
} else {
var G__17806 = (i_17803 + (1));
i_17803 = G__17806;
continue;
}
} else {
...
if(!((nx == null))){
var G__17808 = nx;
var G__17809 = (level__$1 - (1));
x = G__17808;
level__$1 = G__17809;
continue;
} else {
var G__17810 = x;
var G__17811 = (level__$1 - (1));
x = G__17810;
level__$1 = G__17811;
continue;
}
...
var G__17813 = nx;
var G__17814 = (level__$1 - (1));
x = G__17813;
level__$1 = G__17814;
continue;
} else {
var G__17815 = x;
var G__17816 = (level__$1 - (1));
x = G__17815;
level__$1 = G__17816;
continue;
}
...
return cljs.core._write(writer__4887__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
var or__4307__auto__ = (cljs.core.truth_((function (){var and__4295__auto__ = me;
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__4307__auto__,timeout__$1,me){
return (function (){
cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);

return cljs.core.async.impl.protocols.close_BANG_(timeout_channel);
});})(timeout_channel,or__4307__auto__,timeout__$1,me))
,msecs);
