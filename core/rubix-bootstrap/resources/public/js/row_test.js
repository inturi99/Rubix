...
"resources/public/js/lib/tests/row_test.js": function(module, exports, require){
...
var TestRow = React.createClass({displayName: "TestRow",
  ...
  render: function() {
    ...
    var rows = React.createElement(Row, {className: "test-class"}, this.state.value);

    for(var i=0; i < 10; i++) {
      rows = React.createElement(Row, {className: "test-class"}, rows);
    }
...
var PerfTestContainer = React.createClass({displayName: "PerfTestContainer",
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement(TestRow, null), 
        React.createElement(TestRow, null), 
        React.createElement(TestRow, null), 
        React.createElement(TestRow, null), 
        React.createElement(TestRow, null), 
...
App = r("resources/public/js/lib/tests/row_test.js");}());
