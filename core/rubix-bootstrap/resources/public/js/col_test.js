...
"resources/public/js/lib/tests/col_test.js": function(module, exports, require){
...
var TestCol = React.createClass({displayName: "TestCol",
  ...
  componentDidMount: function() {
    ...
    //   this.setState({value: ('Col-' + Math.random())}, function() {
    //     console.timeEnd('render');
    //   });
    // }.bind(this), 5000);
  },
  render: function() {
    ...
    for(var i=0; i < 10000; i++) {
      cols.push(React.createElement(Col, {key: i, className: "test-class"}, this.state.value));
    }
...
var PerfTestContainer = React.createClass({displayName: "PerfTestContainer",
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement(TestCol, null)
      )
    );
  }
});
...
App = r("resources/public/js/lib/tests/col_test.js");}());
