window.Rubix=window.Rubix||{};(function(a){var c=a.event,b,d;b=c.special.debouncedresize={setup:function(){a(this).on("resize",b.handler)},teardown:function(){a(this).off("resize",b.handler)},handler:function(a,f){var g=this,h=arguments,n=function(){a.type="debouncedresize";c.dispatch.apply(g,h)};d&&clearTimeout(d);f?n():d=setTimeout(n,b.threshold)},threshold:150}})(jQuery);
(function(a){var c=a.event,b,d={_:0},e=0,f,g;b=c.special.throttledresize={setup:function(){a(this).on("resize",b.handler)},teardown:function(){a(this).off("resize",b.handler)},handler:function(h,n){var k=this,l=arguments;f=!0;g||(setInterval(function(){e++;if(e>b.threshold&&f||n)h.type="throttledresize",c.dispatch.apply(k,l),f=!1,e=0;9<e&&(a(d).stop(),g=!1,e=0)},30),g=!0)},threshold:0}})(jQuery);
$.fn.serializeObject=function(){var a={};return $.each(this.serializeArray(),function(c,b){var d=a[b.name];"undefined"!=typeof d&&null!==d?$.isArray(d)?d.push(b.value):a[b.name]=[d,b.value]:a[b.name]=b.value}),a};var RubixListeners=[],isSafari=0<Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor"),useTable=isSafari?"inline":"table";
Rubix=function(a,c){this.chart_counter=0;this.master_id=this.uid("master_id");RubixListeners.push(this.master_id);this.data_stack={};this.chart_stack={};this.area_stack_data_stack=[];this.column_stack_data_stack=[];this.root_elem=$(a);this.root_elem.css("position","relative");this.root_elem.addClass("rubixcc-main-chart");this.root_elem.append('<div class="rubixcc-tooltip"></div>');this.root_elem.append('<div class="rubixcc-title"></div>');this.root_elem.append('<div class="rubixcc-subtitle"></div>');
this.root_elem.append('<div class="rubixcc-chart text-center"><div style="margin-top:5px">Loading...</div></div>');this.root_elem.append('<div class="rubixcc-legend"></div>');var b=c.height||150;this.root_elem.width(c.width||"100%").height(b);this.elem=this.root_elem.find(".rubixcc-chart");c.tooltip=c.tooltip||{};this.tooltip=this.root_elem.find(".rubixcc-tooltip");this.tooltip.hide();c&&c.tooltip&&c.tooltip.animate&&this.tooltip.addClass("animate");this.tooltip.html("");this.tooltip.css({"font-family":'Lato, "Lucida Grande", Arial, Helvetica, sans-serif',
"font-size":"12px",position:"absolute",background:"white",color:"#89949B",padding:"10px 15px",display:"none","pointer-events":"none","border-radius":"5px","z-index":100,"min-height":50,"user-select":"none",cursor:"default",border:"3px solid "+(c.tooltip.color?c.tooltip.color:"#89949B"),"box-shadow":"rgba(0, 0, 0, 0.2) 2px 4px 8px",background:"white"});c.legend=c.legend||{};this.legend=this.root_elem.find(".rubixcc-legend");this.legend.css({"font-family":"Lato, 'Lucida Grande', Arial, Helvetica, sans-serif",
"text-align":"center","margin-top":c.legend.top||"-10px","margin-bottom":c.legend.bottom||"5px","user-select":"none",display:c.hideLegend?"none":"block"});this.title=this.root_elem.find(".rubixcc-title");this.subtitle=this.root_elem.find(".rubixcc-subtitle");this.title.css({"font-family":"Lato, 'Lucida Grande', Arial, Helvetica, sans-serif","text-align":"center","user-select":"none","font-weight":"bold","font-size":"16px",color:"steelblue","margin-top":"10px",cursor:"default"});this.subtitle.css({"font-family":"Lato, 'Lucida Grande', Arial, Helvetica, sans-serif",
"text-align":"center","user-select":"none","font-size":"12px",color:"steelblue","margin-top":"5px",cursor:"default",opacity:.8,"font-weight":"bold"});var d=this;this.tooltip.on({mouseover:function(a){d3.select(d.elem.find(".overlay").get(0)).node().__onmousemove(a)},mousemove:function(a){d3.select(d.elem.find(".overlay").get(0)).node().__onmousemove(a)},mouseout:function(a){$(this).hide()}});this.elem.css({width:"100%",height:parseInt(this.root_elem.get(0).style.height),"user-select":"none",cursor:"default",
position:"relative"});this.root_elem.css("height","100%");this.opts=c||{};this.data={};this.charts={};this.extent=[];this.extent_coordinates=[];this.is_touch_device="ontouchstart"in document.documentElement;this.d3_eventSource=function(){for(var a=d3.event,b;b=a.sourceEvent;)a=b;return a};this.custom_interpolations={sankey:function(a){for(var b=a[0][0],c=a[0][1],d,n,k=[b,",",c],l=0,m=a.length;++l<m;)d=a[l][0],n=a[l][1],b=(b+d)/2,k.push("C",b,",",c," ",b,",",n," ",d,",",n),b=d,c=n;return k.join("")}};
this.ylabelcolor=this.xlabelcolor="steelblue";this.first_time=!0;this.last_render=null;this.data_changed=!1;this.setup()};Rubix.prototype.setup=function(){this._setupOpts();this._setupOnce();this._setupRedraw();this.draw()};Rubix.prototype.draw=function(){if(!this.data_changed){if(null!==this.last_render&&300>Date.now()-this.last_render)return;this.last_render=Date.now()}this.data_changed=!1;this.root_elem.is(":visible")&&this._draw($(window).width(),$(window).height())};
Rubix.prototype.uid=function(a){return"rubixcc-"+a+"-"+Math.floor(2147483648*Math.random()).toString(36)};
Rubix.prototype._setupOpts=function(){this.opts.theme_style=this.opts.theme_style||$("body").attr("data-theme")||"light";this.opts.theme_style_color=this.opts.gridColor||("light"===this.opts.theme_style?"#C0D0E0":"#555");this.opts.theme_focus_line_color=this.opts.focusLineColor||("light"===this.opts.theme_style?"#C0D0E0":"#888");this.opts.tickColor=this.opts.tickColor||("light"===this.opts.theme_style?"#666":"#999");this.opts.titleColor=this.opts.titleColor||"steelblue";this.opts.subtitleColor=this.opts.subtitleColor||
"steelblue";this.opts.legend_color_brightness=this.opts.legend_color_brightness||.5;this.title.css("color",this.opts.titleColor);this.subtitle.css("color",this.opts.subtitleColor);"dark"!==this.opts.theme_style&&"dark"!==this.opts.tooltip.theme_style||this.tooltip.css({color:"#aaa","font-weight":"bold",border:"1px solid #222","background-color":"#303030"});this.opts.margin=this.opts.margin||{};this.margin={top:0<=this.opts.margin.top?this.opts.margin.top:25,left:0<=this.opts.margin.left?this.opts.margin.left:
25,right:0<=this.opts.margin.right?this.opts.margin.right:12.5,bottom:0<=this.opts.margin.bottom?this.opts.margin.bottom:25};this.opts.draw=this.opts.draw||{};this.opts.draw={grid:!1===this.opts.draw.grid?!1:!0};this.opts.invertAxes=this.opts.invertAxes||!1;this.opts.axis=this.opts.axis||{};this.opts.axis.x=this.opts.axis.x||{};this.opts.axis.y=this.opts.axis.y||{};this.axis={x:{type:this.opts.axis.x.type||"linear",range:this.opts.axis.x.range||"",tickCount:this.opts.axis.x.tickCount,tickFormat:this.opts.axis.x.tickFormat||
"",label:this.opts.axis.x.label||"",labelColor:this.opts.axis.x.labelColor||"steelblue"},y:{type:this.opts.axis.y.type||"linear",range:this.opts.axis.y.range||"",tickCount:this.opts.axis.y.tickCount,tickFormat:this.opts.axis.y.tickFormat||"",label:this.opts.axis.y.label||"",labelColor:this.opts.axis.y.labelColor||"steelblue"}};this.xlabelcolor=this.opts.axis.x.labelColor;this.ylabelcolor=this.opts.axis.y.labelColor;this.axis.x.label.length&&(this.opts.invertAxes?this.margin.left+=15:this.margin.bottom+=
15);this.axis.y.label.length&&(this.opts.invertAxes?this.margin.bottom+=15:this.margin.left+=15);this.margin.defaultLeft=this.margin.left;this.opts.tooltip=this.opts.tooltip||{};this.opts.tooltip.format=this.opts.tooltip.format||{};this.opts.tooltip.abs=this.opts.tooltip.abs||{};this.tooltipFormatter={format:{x:this.opts.tooltip.format.x||"",y:this.opts.tooltip.format.y||""},abs:{x:this.opts.tooltip.abs.hasOwnProperty("x")?this.opts.tooltip.abs.x:!1,y:this.opts.tooltip.abs.hasOwnProperty("y")?this.opts.tooltip.abs.y:
!1}};if(this.opts.invertAxes){var a=this.axis.x;this.axis.x=this.axis.y;this.axis.y=a;a=this.tooltipFormatter.format.x;this.tooltipFormatter.format.x=this.tooltipFormatter.format.y;this.tooltipFormatter.format.y=a}0!==this.opts.animationSpeed&&(this.animationSpeed=this.opts.animationSpeed||750);this.opts.interval=this.opts.start_interval||0;this.stacked=this.opts.stacked||!1;this.grouped=this.opts.grouped||!1;this.offset=this.opts.offset||"zero";this.order=this.opts.order||"default";this.show_markers=
this.opts.show_markers||!1;this.resize=this.opts.resize||"debounced";this.interpolate=this.opts.interpolate||"linear";switch(this.interpolate){case "sankey":this.interpolate=this.custom_interpolations[this.interpolate]}this.master_detail=this.opts.master_detail||!1;this.master_detail_height=this.opts.master_detail_height||50;this.master_detail&&(this.master_detail_margin_bottom=this.margin.bottom,this.margin.bottom=2*this.margin.bottom+this.master_detail_height);this.opts.title=this.opts.title||"";
this.opts.subtitle=this.opts.subtitle||"";this.title.html(this.opts.title);this.subtitle.html(this.opts.subtitle);(this.opts.title.length||this.opts.subtitle.length)&&this.elem.css("margin-top","-20px");this.opts.title.length?this.title.show():this.title.hide();this.opts.subtitle.length?this.subtitle.show():this.subtitle.hide()};
...
this.axis.x.tickFormat&&("linear"===this.axis.x.type?this.xAxis.tickFormat(d3.format(this.axis.x.tickFormat)):"datetime"===this.axis.x.type&&this.xAxis.tickFormat(d3.time.format(this.axis.x.tickFormat)),this.master_detail&&("linear"===this.axis.x.type?this.xAxis2.tickFormat(d3.format(this.axis.x.tickFormat)):this.xAxis2.tickFormat(d3.time.format(this.axis.x.tickFormat))));this.xGrid=d3.svg.axis();this.xGrid.scale(this.x).orient("bottom").ticks(5).tickSize(-this.height,0,0).tickFormat("");void 0!==
this.axis.x.tickCount&&this.xGrid.ticks(this.axis.x.tickCount);this.master_detail&&(this.xGrid2=d3.svg.axis(),this.xGrid2.scale(this.x2).orient("bottom").ticks(5).tickSize(-this.master_detail_height,0,0).tickFormat(""));this.yAxis=d3.svg.axis();this.yAxis.scale(this.y).orient("left");this.yAxis.ticks(c);"round"!==this.axis.y.range||"linear"!==this.axis.y.type&&"datetime"!==this.axis.y.type||("linear"===this.axis.y.type?this.yAxis.tickFormat(d3.format(this.axis.y.tickFormat)):"datetime"===this.axis.y.type&&
this.yAxis.tickFormat(d3.time.format(this.axis.y.tickFormat)));this.axis.y.tickFormat&&("linear"===this.axis.y.type?this.yAxis.tickFormat(d3.format(this.axis.y.tickFormat)):"datetime"===this.axis.y.type&&this.yAxis.tickFormat(d3.time.format(this.axis.y.tickFormat)));this.yGrid=d3.svg.axis();this.yGrid.scale(this.y).orient("left").ticks(5).tickSize(-this.width,0,0).tickFormat("");void 0!==this.axis.y.tickCount&&this.yGrid.ticks(this.axis.y.tickCount);this.xAxisGroup=this.axis_group.append("g");this.xAxisGroup.attr("class",
"x axis");this.xAxisGroup.attr("transform","translate(0, "+this.height+")");this.xAxisGroup.call(this.xAxis);this.xAxisGroup.select("path").style("fill","none").style("stroke",this.opts.theme_style_color).style("shape-rendering","crispEdges");this.xAxisGroup.selectAll("line").attr("fill","none").attr("stroke",this.opts.theme_style_color).style("shape-rendering","crispEdges");this.master_detail&&(this.xAxisGroup2=this.md_root.append("g"),this.xAxisGroup2.attr("class","x axis"),this.xAxisGroup2.call(this.xAxis2),
this.xAxisGroup2.select("path").style("fill","none"),this.xAxisGroup2.select("line").style("fill","none").style("stroke",this.opts.theme_style_color).style("shape-rendering","crispEdges"),this.xAxisGroup2.selectAll("line").attr("fill","none").attr("stroke",this.opts.theme_style_color).style("shape-rendering","crispEdges"));this.yAxisGroup=this.axis_group.append("g");this.yAxisGroup.attr("class","y axis");this.yAxisGroup.call(this.yAxis);this.yAxisGroup.select("path").style("fill","none").style("stroke",
this.opts.theme_style_color).style("shape-rendering","crispEdges");this.yAxisGroup.selectAll("line").attr("fill","none").attr("stroke",this.opts.theme_style_color).style("shape-rendering","crispEdges");this.opts.draw.grid&&(this.xGridGroup=this.grid_group.append("g"),this.xGridGroup.attr("class","x grid"),this.xGridGroup.attr("transform","translate(0,"+this.height+")"),this.xGridGroup.call(this.xGrid),this.xGridGroup.selectAll("path").style("stroke-width",0),this.xGridGroup.selectAll(".tick").style("stroke",
this.opts.theme_style_color).style("opacity",.7));this.master_detail&&(this.xGridGroup2=this.md_root.select(".md-grid").append("g"),this.xGridGroup2.attr("class","x grid"),this.xGridGroup2.attr("transform","translate(0,"+this.master_detail_height+")"),this.xGridGroup2.call(this.xGrid2),this.xGridGroup2.selectAll("path").style("stroke-width",0),this.xGridGroup2.selectAll(".tick").style("stroke","lightgray").style("opacity",.7));this.opts.draw.grid&&(this.yGridGroup=this.grid_group.append("g"),this.yGridGroup.attr("class",
"y grid"),this.yGridGroup.call(this.yGrid),this.yGridGroup.selectAll("path").style("stroke-width",0),this.yGridGroup.selectAll(".tick").style("stroke",this.opts.theme_style_color).style("opacity",.7));this.resetAxis(a);if(this.master_detail){if("ordinal"===this.axis.x.type)throw this.canvas.select(".noData").text("Master-Detail chart only for quantitative scales."),Error("Master-Detail chart only for quantitative scales.");this.brush=d3.svg.brush();this.brush.x(this.x2);var d=this;if("datetime"===
this.axis.x.type)this.brush.on("brushend",function(){var a=(d.is_touch_device?d3.touches(this,d.d3_eventSource().changedTouches)[0]:d3.mouse(this))[0];if(d.brush.empty()){var b=d.x2(+new Date(d.extent[0])),c=d.x2(+new Date(d.extent[1])),a=b-a,h=[];0>a?(b+=Math.abs(a),c+=Math.abs(a),a=d.x2(+new Date(d.x2.domain()[1])),c>a?(b-=c-a,c=a,h=[d.x2.invert(b),d.x2.invert(c)]):(a=Math.abs(b-c),h=[d.x2.invert(b-a/2),d.x2.invert(c-a/2)])):(b-=Math.abs(a),c-=Math.abs(a),a=Math.abs(b-c),b-=a/2,c-=a/2,a=d.x2(+new Date(d.x2.domain()[0])),
b<a&&(c+=a-b,b=a),h=[d.x2.invert(b),d.x2.invert(c)]);d.extent=h;d.brush.extent(d.extent);d.brush_path.call(d.brush);d._brush()}c=d.brush_path.select(".extent").attr("x");b=d.brush_path.select(".extent").attr("width");a=d.brush_path.select(".extent").attr("height");d.brush_path.select(".left-extent").attr("height",a).attr("width",c).attr("x",0);h=parseFloat(c)+parseFloat(b);d.brush_path.select(".right-extent").attr("height",a).attr("x",h).attr("width",d.md_root.attr("width")-h);d.brush_path.select(".left-border").attr("width",
1).attr("x",c);d.brush_path.select(".left-top-border").attr("width",c);d.brush_path.select(".right-border").attr("width",1).attr("x",h);d.brush_path.select(".right-top-border").attr("x",h).attr("width",d.md_root.attr("width")-h);d.brush_path.select(".bottom-border").attr("x",c).attr("width",b).attr("transform","translate(0, "+(d.master_detail_height+5)+")")});else this.brush.on("brushend",function(){var a=d.is_touch_device?d3.touches(this,d.d3_eventSource().changedTouches)[0]:d3.mouse(this),b=d.x2.invert(a[0]);
if(d.brush.empty()){var c=d.extent[0],a=d.extent[1],b=c-b,h=[];0>b?(c+=Math.abs(b),a+=Math.abs(b),b=d.x2.domain()[1],a>b?(c-=a-b,h=[c,b]):(b=Math.abs(c-a),h=[c-b/2,a-b/2])):(c-=Math.abs(b),a-=Math.abs(b),b=Math.abs(c-a),c-=b/2,a-=b/2,b=d.x2.domain()[0],c<b&&(a+=b-c,c=b),h=[c,a]);d.extent=h;d.brush.extent(d.extent);d.brush_path.call(d.brush);d._brush()}a=d.brush_path.select(".extent").attr("x");c=d.brush_path.select(".extent").attr("width");b=d.brush_path.select(".extent").attr("height");d.brush_path.select(".left-extent").attr("height",
b).attr("width",a).attr("x",0);h=parseFloat(a)+parseFloat(c);d.brush_path.select(".right-extent").attr("height",b).attr("x",h).attr("width",d.md_root.attr("width")-h);d.brush_path.select(".left-border").attr("width",1).attr("x",a);d.brush_path.select(".left-top-border").attr("width",a);d.brush_path.select(".right-border").attr("width",1).attr("x",h);d.brush_path.select(".right-top-border").attr("x",h).attr("width",d.md_root.attr("width")-h);d.brush_path.select(".bottom-border").attr("x",a).attr("width",
c).attr("transform","translate(0, "+(d.master_detail_height+5)+")")});this.brush.on("brush",function(){var a=d.d3_eventSource().type;if("mousemove"===a||"touchmove"===a)$(window).trigger("rubix.sidebar.off"),d._brush(!0,"root");var a=d.brush_path.select(".extent").attr("x"),b=d.brush_path.select(".extent").attr("width"),c=d.brush_path.select(".extent").attr("height");d.brush_path.select(".left-extent").attr("height",c).attr("width",a).attr("x",0);var h=parseFloat(a)+parseFloat(b);d.brush_path.select(".right-extent").attr("height",
c).attr("x",h).attr("width",d.md_root.attr("width")-h);d.brush_path.select(".left-border").attr("width",1).attr("x",a);d.brush_path.select(".left-top-border").attr("width",a);d.brush_path.select(".right-border").attr("width",1).attr("x",h);d.brush_path.select(".right-top-border").attr("x",h).attr("width",d.md_root.attr("width")-h);d.brush_path.select(".bottom-border").attr("x",a).attr("width",b).attr("transform","translate(0, "+(d.master_detail_height+5)+")")});this.extent.length&&(this.brush.extent(this.extent),
this.extent_coordinates.length||(this.extent_coordinates="datetime"===this.axis.x.type||"datetime"===this.axis.y.type?[this.x2(+new Date(this.extent[0])),this.x2(+new Date(this.extent[1]))]:[this.x2(this.extent[0]),this.x2(this.extent[1])]),this._brush())}};
Rubix.prototype._setupSeries=function(){this.grid_group=this.root.append("g").attr("class","grid_group");this.axis_group=this.root.append("g").attr("class","axis_group");this.opts.hideGrid&&this.grid_group.style("display","none");this.opts.hideAxisAndGrid&&(this.grid_group.style("display","none"),this.axis_group.style("display","none"));this.root_cb_series=this.root.append("g").attr("class","cb_series");this.root_stacked_area_series=this.root.append("g").attr("class","stacked_area_series");this.root_area_series=
this.root.append("g").attr("class","area_series");this.root_line_series=this.root.append("g").attr("class","line_series");this.focus_line_group=this.root.append("g").attr("class","focus_line_group");this.symbols_group=this.root.append("g").attr("class","symbols");this.focus_group=this.root.append("g").attr("class","focus_group");this.master_detail&&(this.md_root_stacked_area_series=this.md_layers.append("g").attr("class","md_stacked_area_series"),this.md_root_area_series=this.md_layers.append("g").attr("class",
"md_area_series"),this.md_root_line_series=this.md_layers.append("g").attr("class","md_line_series"))};Rubix.prototype.resetExtent=function(){if(this.brush.extent().length){var a=this.extent_coordinates[0],c=this.extent_coordinates[1];this.extent="datetime"===this.axis.x.type||"datetime"===this.axis.y.type?[this.x2.invert(+new Date(a)),this.x2.invert(+new Date(c))]:[this.x2.invert(a),this.x2.invert(c)];this.brush.extent(this.extent);this._brush_nochange()}};
Rubix.prototype._brush_nochange=function(){try{this.x.domain(this.extent);this.callAxis();for(var a in this.charts)this.charts[a].noRedraw(this)}catch(c){}};
...
Rubix.prototype.resetAxis=function(a){try{"linear"===this.axis.x.type&&"linear"===this.axis.y.type?this._setupLinearAxis():"datetime"===this.axis.x.type&&"linear"===this.axis.y.type||"linear"===this.axis.x.type&&"datetime"===this.axis.y.type?this._setupLinearAxis():"ordinal"===this.axis.x.type&&"ordinal"===this.axis.y.type?this._setupOrdinalAxis(!0):"ordinal"!==this.axis.x.type&&"ordinal"!==this.axis.y.type||this._setupOrdinalAxis(),this.callAxis(a)}catch(c){}};
Rubix.prototype.callAxis=function(a){if(a){if(a=this.root.transition().duration(this.animationSpeed),this.master_detail)var c=this.md_root.transition().duration(this.animationSpeed)}else a=this.root,this.master_detail&&(c=this.md_root);if(this.hasData){if("ordinal"===this.axis.x.type){var b=this.x.domain();if(void 0!==this.axis.x.tickCount&&b.length>this.axis.x.tickCount){for(var d=this,e=d3.range(b.length).map(function(a){return 0===a%d.axis.x.tickCount?b[a]:null}),f=[],g=0;g<e.length;g++)null!==
e[g]&&f.push(e[g]);this.xAxis.tickValues(f)}}else void 0!==this.axis.x.tickCount&&(this.xAxis.ticks(this.axis.x.tickCount),this.master_detail&&this.xAxis2.ticks(this.axis.x.tickCount));"ordinal"===this.axis.y.type||"linear"===this.axis.x.type||"datetime"===this.axis.x.type?(b=this.y.domain(),void 0!==this.axis.y.tickCount&&b.length>this.axis.y.tickCount&&(d=this,e=d3.range(b.length).map(function(a){return 0===a%d.axis.y.tickCount?b[a]:""}),this.yAxis.tickValues(e))):void 0!==this.axis.y.tickCount&&
this.yAxis.ticks(this.axis.y.tickCount);this.canvas.select(".noData").style("display","none");try{a.selectAll(".x.axis").style("display",null).call(this.xAxis),a.selectAll(".y.axis").style("display",null).call(this.yAxis),a.selectAll(".x.grid").style("display",null).call(this.xGrid),a.selectAll(".y.grid").style("display",null).call(this.yGrid)}catch(h){}this.xAxisGroup.selectAll("line").attr("fill","none").attr("stroke",this.opts.theme_style_color).style("shape-rendering","crispEdges");this.yAxisGroup.selectAll("line").attr("fill",
"none").attr("stroke",this.opts.theme_style_color).style("shape-rendering","crispEdges");this.opts.draw.grid&&(this.xGridGroup.selectAll("path").style("stroke-width",0),this.xGridGroup.selectAll(".tick").style("stroke",this.opts.theme_style_color).style("opacity",.7),this.yGridGroup.selectAll("path").style("stroke-width",0),this.yGridGroup.selectAll(".tick").style("stroke",this.opts.theme_style_color).style("opacity",.7));this.xAxisGroup.selectAll("text").style("font",this.fontSize+1+'px Lato, "Lucida Grande", "Lucida Sans Unicode", Verdana, Arial, Helvetica, sans-serif').style("direction",
...
"");"dark"===this.opts.theme_style&&(this.xAxisGroup.selectAll("text").style("font-weight","bold"),this.yAxisGroup.selectAll("text").style("font-weight","bold"))}else this.canvas.select(".noData").style("display",null),a.selectAll(".x.axis").style("display","none"),a.selectAll(".y.axis").style("display","none"),a.selectAll(".x.grid").style("display","none"),a.selectAll(".y.grid").style("display","none");this.master_detail&&(this.hasData?(this.canvas.select(".noData").style("display","none"),c.selectAll(".x.axis").style("display",
null).call(this.xAxis2),c.selectAll(".x.grid").style("display",null).call(this.xGrid2),this.xAxisGroup2&&(this.xAxisGroup2.selectAll("line").attr("fill","none").attr("stroke",this.opts.theme_style_color).style("shape-rendering","crispEdges"),this.xGridGroup2.selectAll("path").style("stroke-width",0),this.xGridGroup2.selectAll(".tick").style("stroke",this.opts.theme_style_color).style("opacity",.7),this.xAxisGroup2.selectAll("text").style("font",this.fontSize+1+'px Lato, "Lucida Grande", "Lucida Sans Unicode", Verdana, Arial, Helvetica, sans-serif').style("direction",
"ltr").style("fill",this.opts.tickColor).style("color",this.opts.tickColor).style("font-style","").style("font-variant","").style("font-weight","").style("line-height",""),"dark"===this.opts.theme_style&&this.xAxisGroup2.selectAll("text").style("font-weight","bold")),this.yAxisGroup2&&(this.yAxisGroup2.selectAll("text").style("font",this.fontSize+1+'px Lato, "Lucida Grande", "Lucida Sans Unicode", Verdana, Arial, Helvetica, sans-serif').style("direction","ltr").style("fill",this.opts.tickColor).style("color",
this.opts.tickColor).style("font-style","").style("font-variant","").style("font-weight","").style("line-height",""),"dark"===this.opts.theme_style&&this.yAxisGroup.selectAll("text").style("font-weight","bold"))):(this.canvas.select(".noData").style("display",null),c.selectAll(".x.axis").style("display","none"),c.selectAll(".y.axis").style("display","none"),c.selectAll(".x.grid").style("display","none"),c.selectAll(".y.grid").style("display","none")));this.opts.hideYAxis&&this.yAxisGroup.style("display",
"none");this.opts.hideXAxis&&this.xAxisGroup.style("display","none");this.opts.hideXAxisTickLines&&this.xGridGroup.style("display","none");this.opts.hideYAxisTickLines&&this.yGridGroup.style("display","none")};
Rubix.prototype._setupRedraw=function(){var a=this;$(window).on("orientationchange."+this.master_id,function(){a.draw()});$(window).on("rubix.redraw."+this.master_id,function(){a.draw()});switch(this.resize){case "always":$(window).on("resize.rubix."+this.master_id,function(){a.draw()});break;case "debounced":$(window).on("debouncedresize.rubix."+this.master_id,function(){a.draw()});break;case "throttled":$(window).on("throttledresize.rubix."+this.master_id,function(){a.draw()});break;default:throw Error("Unknown resize type!");
}};Rubix.prototype._draw=function(a,c){this._cleanElement();this._setSize();this._setupCanvas();this._setupRoot();this._setupSeries();this._setupAxis();for(var b in this.charts)this.charts[b].redraw(this)};Rubix.prototype._cleanElement=function(){this.elem.children().remove()};
Rubix.prototype._setSize=function(){this.outerWidth=this.elem.width();this.outerHeight=this.elem.height();this.opts.hideYAxis&&(this.margin.left=0,this.margin.right=0);this.opts.hideAxisAndGrid&&(this.margin.left=0,this.margin.right=0);this.width=this.outerWidth-this.margin.left-this.margin.right;this.height=this.outerHeight-this.margin.top-this.margin.bottom};
...
Rubix.prototype._setupRoot=function(){this.root=this.canvas.append("g");this.root.attr("width",this.width);this.root.attr("height",this.height);this.opts.hideAxisAndGrid?this.root.attr("transform","translate(0,"+this.margin.top+")"):this.root.attr("transform","translate("+this.margin.left+","+this.margin.top+")");this.hasData?this.canvas.select(".noData").style("display","none"):this.canvas.append("text").attr("class","noData").attr("font-size","30px").attr("text-anchor","middle").attr("transform",
"translate("+this.outerWidth/2+","+this.outerHeight/2+")").attr("font-family",'Lato, "Lucida Grande", Arial, Helvetica, sans-serif').text("No Data");if(this.master_detail){this.md_root=this.canvas.append("g");this.md_root.attr("width",this.width);this.md_root.attr("height",this.master_detail_height);this.opts.hideAxisAndGrid||this.md_root.attr("transform","translate("+this.margin.left+","+(this.margin.top+this.height+this.master_detail_margin_bottom)+")");var a=this.md_root.append("rect");a.attr("width",
this.md_root.attr("width"));a.attr("height",this.md_root.attr("height"));a.attr("fill","none");a.attr("shape-rendering","crispEdges");this.md_root.append("g").attr("class","md-grid").attr("width",this.md_root.attr("width"));this.md_layers=this.md_root.append("g").attr("class","md-layers").attr("clip-path","url(#"+this.master_id+"-clip)");this.defs.append("clipPath").attr("id",this.master_id+"-clip-symbols").append("rect").attr("width",this.md_root.attr("width")).attr("height",this.height+20).attr("transform",
"translate(0, -10)");this.defs.append("clipPath").attr("id",this.master_id+"-clip-brush").append("rect").attr("width",this.md_root.attr("width")+20).attr("height",this.master_detail_height).attr("transform","translate(-10, 1)")}};
Rubix.prototype.marginLeft=function(a){if(!arguments.length)return this.margin.left;this.margin.left=10+a+10<this.margin.defaultLeft?this.margin.defaultLeft:10+a+10;this.axis.x.label.length&&this.opts.invertAxes&&(this.margin.left+=15);this.axis.y.label.length&&!this.opts.invertAxes&&(this.margin.left+=15);this.draw()};
Rubix.prototype.forceRedraw=function(){try{this.hasData=!1;for(var a in this.charts)this.hasData=!0,this.charts[a].forceRedraw(this);this.hasData?(this.canvas.select(".noData").style("display","none"),this.root.selectAll(".axis").style("display",null)):(this.canvas.select(".noData").style("display",null),this.root.selectAll(".axis").style("display","none"))}catch(c){}};
Rubix.prototype.resizePath=function(a){var c=(a=+("e"==a))?1:-1,b=this.master_detail_height/2;return"M"+.5*c+","+b+"A6,6 0 0 "+a+" "+6.5*c+","+(b+6)+"V"+(2*b-6)+"A6,6 0 0 "+a+" "+.5*c+","+2*b+"ZM"+2.5*c+","+(b+8)+"V"+(2*b-8)+"M"+4.5*c+","+(b+8)+"V"+(2*b-8)};
Rubix.prototype._createBrushPath=function(){var a=this;this.brush_path&&this.brush_path.remove();this.brush_path=this.md_root.append("g");this.brush_path.attr("height",this.master_detail_height+5);this.brush_path.attr("width",this.md_root.attr("width"));this.brush_path.attr("class","x brush");this.brush_path.attr("transform","translate(0, -4)");this.brush_path.call(this.brush);var c="rgb(16, 16, 16)";"light"===this.opts.theme_style&&(c="white");this.brush_path.selectAll(".extent").attr("stroke","none").attr("fill-opacity",
0).attr("shape-rendering","crispEdges");this.brush_path.insert("rect",".resize").attr("class","left-extent").attr("fill-opacity",.5).attr("fill",c).style("cursor","crosshair");this.brush_path.insert("rect",".resize").attr("class","right-extent").attr("fill-opacity",.5).attr("fill",c).style("cursor","crosshair");this.brush_path.insert("rect",".resize").attr("class","left-border").attr("x",0).style("fill",this.opts.theme_style_color);this.brush_path.insert("rect",".resize").attr("class","left-top-border").attr("x",
0).style("fill",this.opts.theme_style_color);this.brush_path.insert("rect",".resize").attr("class","right-border").style("fill",this.opts.theme_style_color);this.brush_path.insert("rect",".resize").attr("class","right-top-border").style("fill",this.opts.theme_style_color);this.brush_path.insert("rect",".resize").attr("class","bottom-border").style("fill","rgb(16, 16, 16)").attr("fill-opacity",.3);var c=this.brush_path.select(".extent").attr("x"),b=this.brush_path.select(".extent").attr("width"),d=
this.brush_path.select(".extent").attr("height");this.brush_path.select(".left-extent").attr("height",d).attr("width",c).attr("x",0);var e=parseFloat(c)+parseFloat(b);this.brush_path.select(".right-extent").attr("height",d).attr("x",e).attr("width",this.md_root.attr("width")-e);this.brush_path.select(".left-border").attr("width",1).attr("x",c);this.brush_path.select(".left-top-border").attr("width",c);this.brush_path.select(".right-border").attr("width",1).attr("x",e);this.brush_path.select(".right-top-border").attr("x",
e).attr("width",this.md_root.attr("width")-e);this.brush_path.select(".bottom-border").attr("x",c).attr("width",b).attr("transform","translate(0, "+(this.master_detail_height+5)+")");this.brush_path.selectAll(".resize").append("path").attr("d",function(b){return a.resizePath(b)}).style("fill","#EEE").style("stroke","#666").attr("transform","translate(0, -"+this.master_detail_height/5+")");this.brush_path.selectAll("rect").attr("height",this.master_detail_height+5);this.brush_path.select(".left-top-border").attr("height",
1);this.brush_path.select(".right-top-border").attr("height",1);this.brush_path.select(".bottom-border").attr("height",1);this.extent.length||(this.extent=this.x2.domain(),this.brush.extent(this.extent),this._brush())};Rubix.prototype.bisectLeft=d3.bisector(function(a){return a.x}).left;Rubix.prototype.bisectRight=d3.bisector(function(a){return a.x}).right;
Rubix.prototype.move_tooltip_x=function(a,c,b){var d;c.length&&(d=d3.mean(c)/c.length);var e=a;if("column"===this.axis.x.range||"bar"===this.axis.x.range)a+=this.x.rangeBand()/2;c=this.root_elem;var f=(this.tooltip.outerWidth()-this.tooltip.width())/2,g=a+this.margin.left+f,h=d,n=c.width(),k=g+this.tooltip.outerWidth();if("column"===this.axis.x.range||"bar"===this.axis.x.range)a=e-this.x.rangeBand()/2;k>n&&(g-=k-a-this.margin.left+f);this.tooltip.css("display","inline");this.tooltip.css("display",
useTable);this.tooltip.css({left:g,top:h});a="";var e=this.tooltipFormatter.format.x.length?"datetime"===this.axis.x.type?d3.time.format(this.tooltipFormatter.format.x):d3.format(this.tooltipFormatter.format.x):function(a){return a},f=this.tooltipFormatter.format.y.length?"datetime"===this.axis.y.type?d3.time.format(this.tooltipFormatter.format.y):d3.format(this.tooltipFormatter.format.y):function(a){return a},l;for(l in b)g="datetime"===this.axis.x.type?e(new Date(b[l].x)):b[l].invert?e(this.x.invert(b[l].x)):
e(b[l].x),h="datetime"===this.axis.y.type?null!==b[l].y?f(new Date(b[l].y)):null:b[l].invert?null!==b[l].y?f(this.y.invert(b[l].y)):null:f(b[l].y),g=this.tooltipFormatter.abs.x?Math.abs(g):g,h=this.tooltipFormatter.abs.y?Math.abs(h):h,a="<div style='color: "+b[l].opts.color+"; margin-bottom: 2px; line-height: 22px;'><b style='position:relative; top: -5px; left: -2px;'><span style='font-size: 22px;'>\u25a0 </span><span style='position:relative; top: -3px; left: -2px;'>"+l+"</span></b></div>"+("<div style='font-size: 10px; margin-top: -10px;'>x : "+
g+" </div>")+("<div style='font-size: 10px; margin-top: -5px;'>y : "+h+" </div><br>")+a;a=a.slice(0,a.length-4);this.tooltip.html(a);this.tooltip.outerHeight()+d>=c.height()&&(h=this.margin.top,this.tooltip.css("top",h))};
...
(a-=l-k);this.tooltip.css("display","inline");this.tooltip.css("display",useTable);this.tooltip.css({left:g,top:a});d="";var m,q;m=this.tooltipFormatter.format.x.length?"datetime"===this.axis.x.type?d3.time.format(this.tooltipFormatter.format.x):d3.format(this.tooltipFormatter.format.x):function(a){return a};q=this.tooltipFormatter.format.y.length?"datetime"===this.axis.y.type?d3.time.format(this.tooltipFormatter.format.y):d3.format(this.tooltipFormatter.format.y):function(a){return a};for(var p in b){var r,
t;r="datetime"===this.axis.y.type?q(new Date(b[p].y)):b[p].invert?q(this.y.invert(b[p].y)):q(b[p].y);t="datetime"===this.axis.x.type?m(new Date(b[p].x)):b[p].invert?m(this.x.invert(b[p].x)):m(b[p].x);r=this.tooltipFormatter.abs.x?Math.abs(r):r;t=this.tooltipFormatter.abs.y?Math.abs(t):t;d="<div style='color: "+b[p].opts.color+"; margin-bottom: 2px'><b style='position:relative; top: -5px; left: -2px;'><span style='font-size: 22px;'>\u25a0 </span><span style='position:relative; top: -3px; left: -2px;'>"+
p+"</span></b></div>"+("<div style='font-size: 10px; margin-top: -10px;'>x : "+r+" </div>")+("<div style='font-size: 10px; margin-top: -5px;'>y : "+t+" </div><br>")+d}d=d.slice(0,d.length-4);console.log(d);this.tooltip.html(d)}catch(u){}};
...
this.xlabelcolor||"steelblue"),this.xlabel.attr("stroke","none"),this.xlabel.style("text-anchor","middle"),this.opts.invertAxes?(this.xlabel.attr("y",-this.margin.left+20),this.xlabel.attr("x",-parseInt(this.root.attr("height"))/2),this.xlabel.attr("transform","rotate(-90)"),this.xlabel.text(this.axis.y.label)):(this.xlabel.attr("y",parseInt(this.root.attr("height"))+this.margin.bottom-15),this.xlabel.attr("x",parseInt(this.root.attr("width"))/2),this.xlabel.text(this.axis.x.label)));this.axis.y.label.length&&
(this.ylabel=this.root.append("text"),this.ylabel.style("font-size","12px"),this.ylabel.style("font-weight","bold"),this.ylabel.style("font-family",'Lato, "Lucida Grande", Arial, Helvetica, sans-serif'),this.ylabel.attr("fill",this.ylabelcolor||"steelblue"),this.ylabel.attr("stroke","none"),this.ylabel.style("text-anchor","middle"),this.opts.invertAxes?(this.ylabel.attr("y",parseInt(this.root.attr("height"))+this.margin.bottom-15),this.ylabel.attr("x",parseInt(this.root.attr("width"))/2),this.ylabel.text(this.axis.x.label)):
(this.ylabel.attr("y",-this.margin.left+20),this.ylabel.attr("x",-parseInt(this.root.attr("height"))/2),this.ylabel.attr("transform","rotate(-90)"),this.ylabel.text(this.axis.y.label)));this.focusLine=this.opts.invertAxes?this.focus_line_group.append("line").attr("x1",0).attr("y1",0).attr("x2",this.width).attr("y2",0).attr("stroke",this.opts.theme_focus_line_color).attr("stroke-width",1).attr("shape-rendering","crispEdges").style("display","none").attr("class","focus-line"):this.focus_line_group.append("line").attr("x1",
...
this.overlay=this.root.append("rect");this.overlay.attr("class","overlay");this.overlay.attr("width",this.width);this.overlay.attr("height",this.height);this.overlay.attr("fill","none");this.overlay.attr("pointer-events","all");this.overlay.attr("clip-path","url(#"+this.master_id+"-clip)");a=function(){$(window).trigger("rubix.sidebar.off");d3.event.preventDefault();c.focusLine.style("display",null);$(this).focus()};b=function(){$(window).trigger("rubix.sidebar.off");d3.event.preventDefault();$(this).focus();
if(c.hasData){var a=c.is_touch_device?d3.touches(this)[0]:d3.mouse(this);c.opts.invertAxes?0>a[1]||a[1]>c.height||c.overlayY.call(this,c,a):0>a[0]||a[0]>c.width||c.overlayX.call(this,c,a)}};d=function(){$(window).trigger("rubix.sidebar.on");d3.event.preventDefault();$(this).focus();c.tooltip.hide();for(var a in c.charts)try{c.charts[a].focus.style("display","none"),c.charts[a].off_focus()}catch(b){}c.focusLine.style("display","none")};c.is_touch_device?window.navigator.msPointerEnabled?(this.overlay.on("MSPointerDown",
a),this.overlay.on("MSPointerMove",b),this.overlay.on("MSPointerUp",d)):(this.overlay.on("touchstart",a),this.overlay.on("touchmove",b),this.overlay.on("touchend",d)):(this.overlay.on("mouseover",a),this.overlay.on("mousemove",b),this.overlay.on("mouseout",d))}};Rubix.prototype.runCommand=function(a){for(var c in this.charts)try{this.charts[c][a](this)}catch(b){}};
...
Rubix.StackedAreaSeries=function(a,c){this.opts=c;this.opts.color=this.opts.color||"steelblue";this.opts.marker=this.opts.marker||"circle";this.opts.fillopacity=this.opts.fillopacity||.5;this.opts.strokewidth=this.opts.strokewidth||1;this.opts.noshadow=this.opts.noshadow||!1;this.show_markers=this.opts.show_markers;if(!this.opts.hasOwnProperty("name"))throw Error("StackedAreaSeries should have a 'name' property");this.name=this.opts.name;this.chart_hidden=!1;this.temp_stack=[];this.setup=!1;this.last_stack=
[];this.last_stack_name="";this.last_stack_added=!1;this._setup(a)};
...
Rubix.StackedAreaSeries.prototype.addData=function(a){this.rubix.data_changed=!0;if(!(a instanceof Array))if(a instanceof Object){if(!a.hasOwnProperty("x")&&!a.hasOwnProperty("y"))throw Error("Object must be in the form: {x: ..., y: ...}");a=[a]}else throw Error("Data must be an array or object");a.length&&(this.rubix.opts.noSort||a.sort(function(a,b){return a.x>b.x?1:a.x===b.x?0:-1}),this.data[this.name]=a,this.area_stack_data.push({key:this.name,color:this.opts.color,values:this.data[this.name],
fillopacity:this.opts.fillopacity,strokewidth:this.opts.strokewidth,orderKey:this.area_stack_data.length}),this.rubix.resetAxis(!0),this.rubix.forceRedraw(),this._animate_draw())};
...
function(a){return a.key}),f=e.enter().append("path");f.attr("class","layer").attr("d",function(a){return d.area(a.values)}).attr("fill",function(a){return a.color}).attr("fill-opacity",function(a){return a.fillopacity}).attr("stroke","none");e.exit().remove();if(this.master_detail&&(f.attr("clip-path","url(#"+d.rubix.master_id+"-clip)"),f.classed("clipped",!0),!a)){var g=this.md_root.select(".md-layers > .md_stacked_area_series").selectAll(".layer").data(this.layers,function(a){return a.key}),h=
g.enter().append("path");h.attr("class","layer").attr("d",function(a){return d.master_area(a.values)}).attr("fill",function(a){return a.color}).attr("fill-opacity",function(a){return a.fillopacity}).attr("stroke","none");h.attr("clip-path","url(#"+d.rubix.master_id+"-clip)");h.classed("clipped",!0);g.exit().remove()}for(c=0;c<this.layers.length;c++)if(this.name===this.layers[c].key){var n=this.layers[c].values;this.opts.noshadow||(this.strokePath1=this.stacked_area_series.append("path").attr("class",
this.id+"-line").datum(n).attr("d",this.line).attr("stroke","black").attr("fill","none").attr("stroke-linecap","round").attr("stroke-width",5*this.opts.strokewidth).attr("stroke-opacity",.05000000000000001).attr("transform","translate(1,1)"),this.strokePath2=this.stacked_area_series.append("path").attr("class",this.id+"-line").datum(n).attr("d",this.line).attr("stroke","black").attr("fill","none").attr("stroke-linecap","round").attr("stroke-width",3*this.opts.strokewidth).attr("stroke-opacity",.1).attr("transform",
"translate(1,1)"),this.strokePath3=this.stacked_area_series.append("path").attr("class",this.id+"-line").datum(n).attr("d",this.line).attr("stroke","black").attr("fill","none").attr("stroke-linecap","round").attr("stroke-width",1*this.opts.strokewidth).attr("stroke-opacity",.15000000000000002).attr("transform","translate(1,1)"));this.linePath=this.stacked_area_series.append("path").datum(n).attr("class",this.id+"-line").attr("stroke",this.opts.color).attr("fill","none").attr("stroke-linecap","round").attr("d",
this.line).attr("stroke-width",2*this.opts.strokewidth);this.master_detail&&(a||(this.md_root.select(".md-layers > .md_stacked_area_series").selectAll("."+this.id+"-line").remove(),this.masterLinePath=this.md_root.select(".md-layers > .md_stacked_area_series").append("path").datum(n).attr("class",this.id+"-line").attr("stroke",this.opts.color).attr("fill","none").attr("stroke-linecap","round").attr("d",this.master_line).attr("stroke-width",2*this.opts.strokewidth),this.masterLinePath.attr("clip-path",
"url(#"+d.rubix.master_id+"-clip)"),this.masterLinePath.classed("clipped",!0),this.dataChanged&&(this.rubix.resetExtent(),this.dataChanged=!1)),this.opts.noshadow||(this.strokePath1.attr("clip-path","url(#"+d.rubix.master_id+"-clip)"),this.strokePath2.attr("clip-path","url(#"+d.rubix.master_id+"-clip)"),this.strokePath3.attr("clip-path","url(#"+d.rubix.master_id+"-clip)")),this.linePath.attr("clip-path","url(#"+d.rubix.master_id+"-clip)"),this.opts.noshadow||(this.strokePath1.classed("clipped",!0),
this.strokePath2.classed("clipped",!0),this.strokePath3.classed("clipped",!0)),this.linePath.classed("clipped",!0));break}}catch(k){}this.setup=!0}this.rubix.resetFocus(a)}};Rubix.StackedAreaSeries.prototype.updatePoint=function(a,c,b){this.addPoint(a,c,b)};
...
default:throw Error("Unknown marker type : "+this.opts.marker);}};Rubix.StackedAreaSeries.prototype.on_focus=function(){this.setup&&this.linePath.attr("stroke-width",2*this.opts.strokewidth)};Rubix.StackedAreaSeries.prototype.off_focus=function(){this.setup&&this.linePath.attr("stroke-width",2*this.opts.strokewidth)};window.Rubix=window.Rubix||{};var slugify=function(a){a=a.replace(/[^-a-zA-Z0-9,&\s]+/ig,"");a=a.replace(/-/gi,"_");return a=a.replace(/\s/gi,"-")};
Rubix.Pie=function(a,c){return new Rubix.PieDonut(a,"pie",c)};Rubix.Donut=function(a,c){return new Rubix.PieDonut(a,"donut",c)};
Rubix.PieDonut=function(a,c,b){b=b||{};this.type=c;this.is_touch_device="ontouchstart"in document.documentElement;this.legend_hidden={};this.chart_counter=0;this.master_id=this.uid("master_id");this.area_stack_data_stack=[];this.column_stack_data_stack=[];this.root_elem=$(a);this.root_elem.css("position","relative");this.root_elem.addClass("rubixccnium-main-chart");this.root_elem.append('<div class="rubixccnium-tooltip"></div>');this.root_elem.append('<div class="rubixccnium-title"></div>');this.root_elem.append('<div class="rubixccnium-subtitle"></div>');
this.root_elem.append('<div class="rubixccnium-chart"><div style="margin-top:5px">Loading...</div></div>');this.root_elem.append('<div class="rubixccnium-legend"></div>');a=b.width||"100%";c=b.height||150;this.elem_width=a;this.elem_height=c;this.root_elem.width(a).height(c);this.elem=this.root_elem.find(".rubixccnium-chart");this.tooltip=this.root_elem.find(".rubixccnium-tooltip");this.tooltip.hide();this.tooltip.html("");b.tooltip=b.tooltip||{};this.tooltip.css({"font-family":'Lato, "Lucida Grande", Arial, Helvetica, sans-serif',
"font-size":"12px",position:"absolute",background:"white",color:"#89949B",display:"none",padding:"5px 15px","pointer-events":"none","border-radius":"5px","z-index":100,"min-height":50,"user-select":"none",cursor:"default",border:"3px solid "+(b.tooltip.color?b.tooltip.color:"#89949B"),"box-shadow":"rgba(0, 0, 0, 0.2) 2px 4px 8px",background:"white"});b.legend=b.legend||{};this.legend=this.root_elem.find(".rubixccnium-legend");this.legend.css({"font-family":"Lato, 'Lucida Grande', Arial, Helvetica, sans-serif",
"text-align":"center","margin-top":b.legend.top||"-10px","margin-bottom":b.legend.bottom||"5px","user-select":"none",display:b.hideLegend?"none":"block"});this.title=this.root_elem.find(".rubixccnium-title");this.subtitle=this.root_elem.find(".rubixccnium-subtitle");this.title.css({"font-family":"Lato, 'Lucida Grande', Arial, Helvetica, sans-serif","text-align":"center","user-select":"none","font-weight":"bold","font-size":"16px",color:"steelblue","margin-top":"10px",cursor:"default"});this.subtitle.css({"font-family":"Lato, 'Lucida Grande', Arial, Helvetica, sans-serif",
"text-align":"center","user-select":"none","font-size":"10px",color:"steelblue","margin-top":"10px",cursor:"default",opacity:.8});this.elem.css({width:"100%",height:parseInt(this.root_elem.get(0).style.height),"user-select":"none",cursor:"default"});this.root_elem.css("height","100%");this.opts=b||{};this.data=[];this.is_touch_device="ontouchstart"in document.documentElement;this.d3_eventSource=function(){for(var a=d3.event,b;b=a.sourceEvent;)a=b;return a};this.last_render=null;this.data_changed=
!1;this.setup()};Rubix.PieDonut.prototype.setup=function(){this._setupOpts();this._setupOnce();this._setupRedraw();this.draw()};
...
this.title.css("color",this.opts.titleColor);this.subtitle.css("color",this.opts.subtitleColor);"dark"===this.opts.theme_style&&this.tooltip.css({color:"#aaa","font-weight":"bold",border:"1px solid #222","background-color":"#303030"});this.opts.margin=this.opts.margin||{};this.margin={top:this.opts.margin.top||25,left:this.opts.margin.left||25,right:this.opts.margin.right||25,bottom:this.opts.margin.bottom||25};this.opts.tooltip=this.opts.tooltip||{};this.opts.tooltip.format=this.opts.tooltip.format||
{};this.tooltipFormatter={format:{x:this.opts.tooltip.format.x||"",y:this.opts.tooltip.format.y||""}};this.resize=this.opts.resize||"throttled";this.opts.title=this.opts.title||"";this.opts.subtitle=this.opts.subtitle||"";this.title.html(this.opts.title);this.subtitle.html(this.opts.subtitle);(this.opts.title.length||this.opts.subtitle.length)&&this.elem.css("margin-top","-20px");this.opts.title.length?this.title.show():this.title.hide();this.opts.subtitle.length?this.subtitle.show():this.subtitle.hide()};
Rubix.PieDonut.prototype._setupOnce=function(){};
Rubix.PieDonut.prototype._setupRedraw=function(){var a=this;$(window).on("orientationchange",function(){a.draw()});$(window).on("rubix.redraw."+this.master_id,function(){a.draw()});switch(this.resize){case "always":$(window).on("resize",function(){a.draw()});break;case "debounced":$(window).on("debouncedresize",function(){a.draw()});break;case "throttled":$(window).on("throttledresize",function(){a.draw()});break;default:throw Error("Unknown resize type!");}};
...
Rubix.PieDonut.prototype._setupCanvas=function(){this.elem.html("");this.canvas=d3.select(this.elem.get(0)).append("svg");this.canvas.attr("width",this.outerWidth);this.canvas.attr("height",this.outerHeight);this.canvas.append("desc").text("Powered by Rubix\u00c6\u017eium")};
...
'Lato, "Lucida Grande", Arial, Helvetica, sans-serif').text("No Data")};Rubix.PieDonut.prototype._setupSeries=function(){this.root_piedonut_series=this.root.append("g").attr("class","piedonut_series").attr("transform","translate("+this.width/2+","+this.height/2+")")};Rubix.PieDonut.prototype.uid=function(a){return"rubixcc-pie-donut-"+a+"-"+Math.floor(2147483648*Math.random()).toString(36)};
Rubix.PieDonut.prototype.addData=function(a){this.data_changed=!0;a.forEach(function(a){a.value=+a.value});this.data=a;this._setupLegend();this.final_draw("launch")};
Rubix.PieDonut.prototype._setupLegend=function(){var a=this;this.legend.children().remove();for(var c=0;c<this.data.length;c++)this.legend.append("<div class='"+this.master_id+"-legend-labels' data-name='"+this.data[c].name+"' style='cursor: pointer; display: inline-block; font-weight: bold; margin-right: 10px; color: "+(this.opts.global_legend_color||this.data[c].color)+"'><span style='font-size: 22px;'>\u25a0 </span><span style='font-size: 12px; position:relative; top: -3px; left: -2px;'>"+this.data[c].name+
"</span></div>");$("."+this.master_id+"-legend-labels").css({opacity:.9});for(var b in this.legend_hidden)$("[data-name="+this.legend_hidden[b]+"]").css({opacity:.2}).addClass("toggle");$("."+this.master_id+"-legend-labels").off().on({hover:function(b){var c=$(this).hasClass("toggle"),f=$(this).attr("data-name"),f="#"+a.master_id+"-"+slugify(f);if(!c)switch(b.type){case "mouseenter":$(this).css({opacity:1});d3.select(f).node().__onmouseover(b);break;case "mouseleave":$(this).css({opacity:.9}),d3.select(f).node().__onmouseout(b)}},
click:function(b){b=$(this).hasClass("toggle");var c=$(this).attr("data-name"),f="#"+a.master_id+"-"+slugify(c);b?($(this).css({opacity:1}),$(this).removeClass("toggle"),$(f).fadeIn(),delete a.legend_hidden[f]):($(this).css({opacity:.2}),$(this).addClass("toggle"),$(f).fadeOut(),a.legend_hidden[f]=c)}})};
...
"-"+slugify(a.data.name)}).style("fill",function(a,b){return a.data.color}).style("stroke","white").append("path").attr("d",function(a){return b({startAngle:0,endAngle:0})});"launch"===a?(this.old_pie_data=d(this.data),setTimeout(function(){g.transition().attrTween("d",function(a){var c=d3.interpolate({startAngle:0,endAngle:0},{startAngle:a.startAngle,endAngle:a.endAngle});return function(a){return b(c(a))}}).duration(500)},15)):"add"===a?e.transition().duration(500).each("end",function(){c.old_pie_data=
d(c.data)}).select("path").attrTween("d",function(a,d){var e=0,f=0;try{e=c.old_pie_data[d].startAngle,f=c.old_pie_data[d].endAngle}catch(g){e=c.old_pie_data[c.old_pie_data.length-1].startAngle,f=c.old_pie_data[c.old_pie_data.length-1].endAngle}var h=d3.interpolate({startAngle:e,endAngle:f},{startAngle:a.startAngle,endAngle:a.endAngle});a.data.hasOwnProperty("_remove")&&c.data.splice(d,1);c._setupLegend();return function(a){return b(h(a))}}):(this.old_pie_data=d(this.data),g.attr("d",function(a){return b(a)}));
a="mouseover";var h="mousemove",n="mouseout";this.is_touch_device&&(h=a="touchstart",n="touchend");var k;f.on(a,function(a){clearTimeout(k);var d=b.centroid(a),e=Math.sqrt(Math.pow(d[0],2)+Math.pow(d[1],2));a=d[0]/e*8;d=d[1]/e*8;c.is_touch_device||d3.select(this).transition().duration(150).attr("transform","translate("+[a,d]+")")});f.on(h,function(a,b){clearTimeout(k);var d=c.is_touch_device?d3.touches(this,c.d3_eventSource().changedTouches)[0]:d3.mouse(this);c.tooltip.css("display",useTable);c.tooltip.css({left:c.width/
2-c.margin.left/2+d[0],top:c.height/2-c.margin.top/2+d[1]});c.tooltip.html("<div style='color: "+a.data.color+";'><b><span style='font-size: 22px;'>\u25a0 </span><span style='position:relative; top: -3px; left: -2px;'>"+a.data.name+" :</span></b> <span style='position:relative; top: -3px; left: -2px;'>"+a.data.value+"</span></div>");d3.select(this).style("fill",a.data.color)});f.on(n,function(a,b){var d=this;c.is_touch_device?(k=setTimeout(function(){c.tooltip.hide()},3E3),setTimeout(function(){d3.select(d).style("fill",
a.data.color)},3E3)):(c.tooltip.hide(),d3.select(d).style("fill",a.data.color),d3.select(d).transition().duration(150).attr("transform","translate(0, 0)"))});e.exit().remove();for(var l in this.legend_hidden)$(l).hide()};Rubix.PieDonut.prototype.removePoint=function(a){for(var c=!1,b=0;b<this.data.length;b++)if(this.data[b].name===a){c=!0;this.data[b].value=0;this.data[b]._remove=!0;break}c&&this.final_draw("add")};Rubix.PieDonut.prototype.updatePoint=function(a){this.addPoint(a)};
Rubix.PieDonut.prototype.addPoint=function(a){this.data_changed=!0;for(var c=!1,b=0;b<this.data.length;b++)if(this.data[b].name===a.name){c=!0;this.data[b].value=+a.value;break}c||this.data.push(a);this.final_draw("add")};window.Rubix=window.Rubix||{};
Rubix.LineSeries=function(a,c){this.opts=c;this.opts.color=this.opts.color||"steelblue";this.opts.marker=this.opts.marker||"circle";this.opts.scatter=this.opts.scatter||!1;this.opts.noshadow=this.opts.noshadow||!1;this.show_markers=this.opts.show_markers;this.opts.strokewidth=this.opts.strokewidth||1;if(!this.opts.hasOwnProperty("name"))throw Error("LineSeries should have a 'name' property");this.name=this.opts.name;this.chart_hidden=!1;this.temp_stack=[];this.setup=!1;this._setup(a)};
...
Rubix.LineSeries.prototype.addData=function(a){this.rubix.data_changed=!0;if(!(a instanceof Array))if(a instanceof Object){if(!a.hasOwnProperty("x")&&!a.hasOwnProperty("y"))throw Error("Object must be in the form: {x: ..., y: ...}");a=[a]}else throw Error("Data must be an array or object");a.length&&(this.rubix.opts.noSort||a.sort(function(a,b){return a.x>b.x?1:a.x===b.x?0:-1}),this.data[this.name]=a,this.rubix.resetAxis(!1),this.rubix.forceRedraw(),this._animate_draw())};
Rubix.LineSeries.prototype.draw=function(a){if(this.name&&this.data&&this.data.hasOwnProperty(this.name)&&this.data[this.name].length){var c=this;if(this.line_series.selectAll("."+this.id)[0].length)this.rubix.runCommand("globalRedraw");else{this.line_series.selectAll("."+this.id+".clipped").remove();this.opts.scatter||(this.opts.noshadow||(this.strokePath1=this.line_series.append("path").attr("class",this.id+" line").datum(this.data[this.name]).attr("d",this.line).attr("stroke","black").attr("fill",
"none").attr("stroke-linecap","round").attr("stroke-width",5*this.opts.strokewidth).attr("stroke-opacity",.05000000000000001).attr("transform","translate(1,1)"),this.strokePath2=this.line_series.append("path").attr("class",this.id+" line").datum(this.data[this.name]).attr("d",this.line).attr("stroke","black").attr("fill","none").attr("stroke-linecap","round").attr("stroke-width",3*this.opts.strokewidth).attr("stroke-opacity",.1).attr("transform","translate(1,1)"),this.strokePath3=this.line_series.append("path").attr("class",
this.id+" line").datum(this.data[this.name]).attr("d",this.line).attr("stroke","black").attr("fill","none").attr("stroke-linecap","round").attr("stroke-width",1*this.opts.strokewidth).attr("stroke-opacity",.15000000000000002).attr("transform","translate(1,1)")),this.linePath=this.line_series.append("path").datum(this.data[this.name]).attr("class",this.id+" line").attr("stroke",this.opts.color).attr("fill","none").attr("stroke-linecap","round").attr("d",this.line).attr("stroke-width",2*this.opts.strokewidth));
if(this.master_detail){if(this.opts.scatter){this.md_root.select(".md-layers > .md_line_series").attr("clip-path","url(#"+c.rubix.master_id+"-clip)");var c=this,b=this.data[this.name];this.markers_master=this.md_root.select(".md-layers > .md_line_series").selectAll("."+this.id+"-marker");switch(this.opts.marker){case "circle":case "cross":case "square":case "diamond":case "triangle-up":case "triangle-down":var d=d3.svg.symbol();d.type(this.opts.marker);b=this.markers_master.data(b);b.enter().append("path").attr("d",
d).attr("class",this.id+"-marker").attr("fill",this.opts.color).style("display",function(a){return null===a.y?"none":null}).attr("stroke","none").attr("transform",function(a){var b=a.y;isNaN(b)&&(b=0);if(c.rubix.opts.invertAxes){var d=c.rubix.y(a.x);a=c.rubix.x(b);if("column"===c.rubix.axis.y.range||"bar"===c.rubix.axis.y.range)d+=c.rubix.y.rangeBand()/2}else if(d=c.rubix.y2(b),a=c.rubix.x2(a.x),"column"===c.rubix.axis.x.range||"bar"===c.rubix.axis.x.range)a+=c.rubix.x.rangeBand()/2;return"translate("+
a+","+d+")"});b.exit().remove();break;default:throw Error("Unknown marker type : "+this.opts.marker);}}else this.md_root.select(".md-layers > .md_line_series").selectAll("."+this.id+".clipped").remove(),this.masterLinePath=this.md_root.select(".md-layers > .md_line_series").append("path").datum(this.data[this.name]).attr("class",this.id+" line").attr("stroke",this.opts.color).attr("fill","none").attr("stroke-linecap","round").attr("d",this.master_line).attr("stroke-width",2*this.opts.strokewidth),
this.masterLinePath.attr("clip-path","url(#"+c.rubix.master_id+"-clip)"),this.masterLinePath.classed("clipped",!0);this.dataChanged&&(this.rubix.resetExtent(),this.dataChanged=!1);this.opts.scatter||(this.opts.noshadow||(this.strokePath1.attr("clip-path","url(#"+c.rubix.master_id+"-clip)"),this.strokePath2.attr("clip-path","url(#"+c.rubix.master_id+"-clip)"),this.strokePath3.attr("clip-path","url(#"+c.rubix.master_id+"-clip)")),this.linePath.attr("clip-path","url(#"+c.rubix.master_id+"-clip)"),this.opts.noshadow||
...
Rubix.LineSeries.prototype.update=function(a){if(!(a instanceof Array))if(a instanceof Object){if(!a.hasOwnProperty("x")&&!a.hasOwnProperty("y"))throw Error("Object must be in the form: {x: ..., y: ...}");a=[a]}else throw Error("Data must be an array or object");this.rubix.opts.noSort||a.sort(function(a,b){return a.x>b.x?1:a.x===b.x?0:-1});this.data[this.name]=a;this.setup?this._animate_draw():(this.rubix.resetAxis(!1),this.rubix.forceRedraw())};
Rubix.LineSeries.prototype.updatePoint=function(a,c,b){this.addPoint(a,c,b)};Rubix.LineSeries.prototype.removePoint=function(a,c){if(this.chart_hidden)this.temp_stack.push({type:"removePoint",ref:a});else{this.data[this.name]||(this.data[this.name]=[]);for(var b=0;b<this.data[this.name].length;b++)if(this.data[this.name][b].x===a){this.data[this.name].splice(b,1);break}this.master_detail&&(this.dataChanged=!0);c||(this.setup?this._animate_draw():(this.rubix.resetAxis(!0),this.rubix.forceRedraw()))}};
Rubix.LineSeries.prototype.addPoint=function(a,c,b){this.rubix.data_changed=!0;if(!(a instanceof Object)||a instanceof Array)throw Error("Object required for addPoint");if(!a.hasOwnProperty("x")&&!a.hasOwnProperty("y"))throw Error("Object must be in the form: {x: ..., y: ...}");if(this.chart_hidden)this.temp_stack.push({type:"addPoint",data:a,shift:c});else{this.data[this.name]||(this.data[this.name]=[]);for(var d=!1,e=0;e<this.data[this.name].length;e++)if(this.data[this.name][e].x===a.x){this.data[this.name][e].y=
...
this.opts.marker);}};Rubix.LineSeries.prototype.on_focus=function(){this.setup&&this.linePath.attr("stroke-width",2*this.opts.strokewidth)};Rubix.LineSeries.prototype.off_focus=function(){this.setup&&this.linePath.attr("stroke-width",2*this.opts.strokewidth)};window.Rubix=window.Rubix||{};
Rubix.ColumnSeries=function(a,c){this.type="column_series";this.opts=c;this.opts.color=this.opts.color||"steelblue";this.opts.marker=this.opts.marker||"circle";this.opts.nostroke=this.opts.nostroke||"";this.opts.fillopacity=this.opts.fillopacity||.85;this.show_markers=this.opts.show_markers;if(!this.opts.hasOwnProperty("name"))throw Error("ColumnSeries should have a 'name' property");this.name=this.opts.name;this.chart_hidden=!1;this.temp_stack=[];this.setup=!1;this.last_stack=[];this.last_stack_name=
"";this.last_stack_added=!1;this.count=0;this._setup(a)};
...
Rubix.ColumnSeries.prototype.addData=function(a){this.rubix.data_changed=!0;if(!(a instanceof Array))if(a instanceof Object){if(!a.hasOwnProperty("x")&&!a.hasOwnProperty("y"))throw Error("Object must be in the form: {x: ..., y: ...}");a=[a]}else throw Error("Data must be an array or object");if(a.length){this.rubix.opts.noSort||a.sort(function(a,b){return a.x>b.x?1:a.x===b.x?0:-1});var c=0,b=[],d;for(d in this.data){var e=this.data[d].length;if(e>c)for(c=e,b=[],e=0;e<c;e++)b.push(this.data[d][e].x)}this.rubix.maxLen=
c;this.data[this.name]=a;for(d in this.data)if(e=this.data[d].length,e<c){a=b.concat();for(e=0;e<this.data[d].length;e++){var f=a.indexOf(this.data[d][e].x);a.splice(f,1)}for(e=0;e<a.length;e++)this.rubix.charts[d].addPoint({x:a[e],y:null})}this.column_stack.push({key:this.name,color:this.opts.color,marker:this.opts.marker,values:this.data[this.name],orderKey:this.column_stack.length});this.rubix.resetAxis();this.rubix.forceRedraw();this._animate_draw()}};
Rubix.ColumnSeries.prototype._createRect=function(){var a=this,c="white";this.opts.nostroke&&(c="none");c=this.columnGroup.selectAll("rect").data(function(a){return a.values}).enter().append("rect").attr("stroke",c);this.grouped?this.rubix.opts.invertAxes?(c.attr("x",function(b,c,e){b=a.rubix.x(0);return isNaN(b)?null:b}),c.attr("y",function(b,c,e){return a.rubix.y(b.x)+a.rubix.y.rangeBand()/a.layers.length*e}),c.attr("class",function(b,c,e){return"column-"+(a.rubix.y(b.x)+a.rubix.y.rangeBand()/a.layers.length*
(a.layers.length-1)+a.rubix.y.rangeBand()/(2*a.layers.length))}),c.attr("width",function(b){b=Math.abs(a.rubix.x(b.y)-a.rubix.x(0));return isNaN(b)?null:b}),c.attr("height",a.rubix.y.rangeBand()/a.layers.length),c.attr("transform",function(b){var c=a.rubix.x(b.y_new)-a.rubix.x(0);return 0>b.y?"translate("+-Math.abs(c)+",0)":"translate(0,0)"})):(c.attr("x",function(b,c,e){return a.rubix.x(b.x)+a.rubix.x.rangeBand()/a.layers.length*e}),c.attr("y",function(b){b=a.rubix.y(0);return isNaN(b)?null:b}),
c.attr("class",function(b,c,e){return"column-"+(a.rubix.x(b.x)+a.rubix.x.rangeBand()/a.layers.length*(a.layers.length-1)+a.rubix.x.rangeBand()/(2*a.layers.length))}),c.attr("width",a.rubix.x.rangeBand()/a.layers.length),c.attr("height",function(b){b=Math.abs(a.rubix.y(b.y)-a.rubix.y(0));return isNaN(b)?null:b}),c.attr("transform",function(b){var c=a.rubix.y(b.y_new)-a.rubix.y(0);return 0<b.y?"translate(0,"+-Math.abs(c)+")":"translate(0,0)"})):this.rubix.opts.invertAxes?(c.attr("x",function(b){b=a.rubix.x(b.y0);
return isNaN(b)?null:b}),c.attr("y",function(b){return a.rubix.y(b.x)||0}),c.attr("class",function(b){return"column-"+(a.rubix.y(b.x)+a.rubix.y.rangeBand()/2)}),c.attr("width",function(b){b=Math.abs(a.rubix.x(b.y0)-a.rubix.x(b.y+b.y0));return isNaN(b)?null:b}),c.attr("height",a.rubix.y.rangeBand()),c.attr("transform",function(b){return 0>b.y?"translate("+-Math.abs(a.rubix.x(b.y0)-a.rubix.x(b.y+b.y0))+",0)":null})):(c.attr("x",function(b){return a.rubix.x(b.x)}),c.attr("y",function(b){b=a.rubix.y(b.y0);
return isNaN(b)?null:b}),c.attr("class",function(b){return"column-"+(a.rubix.x(b.x)+a.rubix.x.rangeBand()/2)}),c.attr("width",a.rubix.x.rangeBand()),c.attr("height",function(b){b=Math.abs(a.rubix.y(b.y0)-a.rubix.y(b.y+b.y0));return isNaN(b)?null:b}),c.attr("transform",function(b){return 0<b.y?"translate(0,"+-Math.abs(a.rubix.y(b.y0)-a.rubix.y(b.y+b.y0))+")":null}))};
Rubix.ColumnSeries.prototype.draw=function(a){try{if(this.name&&this.data&&this.data.hasOwnProperty(this.name)&&this.data[this.name].length){var c=this.layers;try{this.layers=this.stack(this.column_stack)}catch(b){this.layers=c}if(!this.grouped)for(var d=this.rubix.maxLen,c=0;c<d;c++){for(var e=this.layers[0].values[c].x,f=null,g=0;g<this.layers.length;g++)for(var h=0;h<d;h++)try{if(this.layers[g].values[h].x===e){0<=this.layers[g].values[h].y&&(null===this.layers[g].values[h].y?this.layers[g].values[h].y0=
null:(null===f&&(f=0),this.layers[g].values[h].y0=f,f+=this.layers[g].values[h].y));break}}catch(n){this.layers[g].values.push({x:e,y:null,y0:null,y_new:null})}f=null;for(g=this.layers.length-1;0<=g;g--)for(h=0;h<d;h++)try{if(this.layers[g].values[h].x===e){0>this.layers[g].values[h].y&&(null===this.layers[g].values[h].y?this.layers[g].values[h].y0=null:(null===f&&(f=0),this.layers[g].values[h].y0=-f,f+=Math.abs(this.layers[g].values[h].y)));break}}catch(k){this.layers[g].values.push({x:e,y:null,
y0:null,y_new:null})}}var l=this;if(this.cb_series.selectAll("."+this.id)[0].length)this.rubix.runCommand("globalRedraw");else{try{this.cb_series.selectAll(".column-layer").remove();var m=this.cb_series.selectAll(".column-layer").data(this.layers,function(a,b){a.key===l.name&&(l.count=b);return a.key});this.columnGroup=m.enter().append("g");this.columnGroup.attr("class","column-layer").attr("fill",function(a){return a.color}).attr("fill-opacity",this.opts.fillopacity);this._createRect();m.exit().remove()}catch(q){}this.setup=
!0}this.rubix.resetFocus(a)}}catch(p){}};Rubix.ColumnSeries.prototype.update=function(a){if(!(a instanceof Array))if(a instanceof Object){if(!a.hasOwnProperty("x")&&!a.hasOwnProperty("y"))throw Error("Object must be in the form: {x: ..., y: ...}");a=[a]}else throw Error("Data must be an array or object");this.rubix.opts.noSort||a.sort(function(a,b){return a.x>b.x?1:a.x===b.x?0:-1});this.data[this.name]=a;this.setup?this._animate_draw():(this.rubix.resetAxis(!0),this.rubix.forceRedraw())};
...
Rubix.ColumnSeries.prototype.addPoint=function(a,c,b){this.rubix.data_changed=!0;if(!(a instanceof Object)||a instanceof Array)throw Error("Object required for addPoint");if(!a.hasOwnProperty("x")&&!a.hasOwnProperty("y"))throw Error("Object must be in the form: {x: ..., y: ...}");if(this.chart_hidden)this.temp_stack.push({type:"addPoint",data:a,shift:c});else{this.data[this.name]||(this.data[this.name]=[]);for(var d=!1,e=0;e<this.data[this.name].length;e++)if(this.data[this.name][e].x===a.x){this.data[this.name][e].y=
...
Rubix.ColumnSeries.prototype._animate_draw=function(){try{for(var a=this.root.selectAll(".y.axis").selectAll("text")[0],c=[],b=0;b<a.length;b++)c.push(a[b].getBBox().width);d3.max(c);this.rubix.resetAxis(!0);this.rubix.runCommand("globalRedraw");a=this.root.selectAll(".y.axis").selectAll("text")[0];c=[];for(b=0;b<a.length;b++)c.push(a[b].getBBox().width);var d=d3.max(c);this.rubix.marginLeft(d);this.rubix.resetFocus()}catch(e){}};Rubix.ColumnSeries.prototype.hidden=function(){this.chart_hidden=!0};
...
this.opts.marker);}};Rubix.ColumnSeries.prototype.on_focus=function(a,c){if(this.setup){this.off_focus();if(this.rubix.opts.invertAxes){c=c.toString().replace(".","\\.");var b=this.cb_series.selectAll(".column-"+c)}else a=a.toString().replace(".","\\."),b=this.cb_series.selectAll(".column-"+a);b.classed("filled",!0);b.attr("fill-opacity",1);b.attr("stroke-width",2)}};
Rubix.ColumnSeries.prototype.off_focus=function(){if(this.setup){var a=this.cb_series.selectAll(".filled");a.classed("filled",!1);a.attr("fill-opacity",.85);a.attr("stroke-width",1)}};window.Rubix=window.Rubix||{};
Rubix.AreaSeries=function(a,c){this.opts=c;this.opts.color=this.opts.color||"steelblue";this.opts.marker=this.opts.marker||"circle";this.opts.fillopacity=this.opts.fillopacity||.5;this.opts.strokewidth=this.opts.strokewidth||1;this.opts.noshadow=this.opts.noshadow||!1;this.show_markers=this.opts.show_markers;if(!this.opts.hasOwnProperty("name"))throw Error("AreaSeries should have a 'name' property");this.name=this.opts.name;this.chart_hidden=!1;this.temp_stack=[];this.animating=this.setup=!1;this._setup(a)};
...
Rubix.AreaSeries.prototype.noRedraw=function(a){this._setup(a);this.draw(!0)};
Rubix.AreaSeries.prototype.addData=function(a){this.rubix.data_changed=!0;if(!(a instanceof Array))if(a instanceof Object){if(!a.hasOwnProperty("x")&&!a.hasOwnProperty("y"))throw Error("Object must be in the form: {x: ..., y: ...}");a=[a]}else throw Error("Data must be an array or object");a.length&&(this.rubix.opts.noSort||a.sort(function(a,b){return a.x>b.x?1:a.x===b.x?0:-1}),this.data[this.name]=a,this.rubix.resetAxis(!1),this.rubix.forceRedraw(),this._animate_draw())};
Rubix.AreaSeries.prototype.draw=function(a){this.name&&this.data&&this.data.hasOwnProperty(this.name)&&this.data[this.name].length&&(this.area_series.selectAll("."+this.id)[0].length?this.rubix.runCommand("globalRedraw"):(this.area_series.selectAll("."+this.id+".clipped").remove(),this.opts.noshadow||(this.strokePath1=this.area_series.append("path").attr("class",this.id+" line").datum(this.data[this.name]).attr("d",this.line).attr("stroke","black").attr("fill","none").attr("stroke-linecap","round").attr("stroke-width",
5*this.opts.strokewidth).attr("stroke-opacity",.05000000000000001).attr("transform","translate(1,1)"),this.strokePath2=this.area_series.append("path").attr("class",this.id+" line").datum(this.data[this.name]).attr("d",this.line).attr("stroke","black").attr("fill","none").attr("stroke-linecap","round").attr("stroke-width",3*this.opts.strokewidth).attr("stroke-opacity",.1).attr("transform","translate(1,1)"),this.strokePath3=this.area_series.append("path").attr("class",this.id+" line").datum(this.data[this.name]).attr("d",
this.line).attr("stroke","black").attr("fill","none").attr("stroke-linecap","round").attr("stroke-width",1*this.opts.strokewidth).attr("stroke-opacity",.15000000000000002).attr("transform","translate(1,1)")),this.areaPath=this.area_series.append("path").attr("class",this.id+" area").datum(this.data[this.name]).attr("d",this.area).attr("fill",this.opts.color).attr("fill-opacity",this.opts.fillopacity).attr("stroke","none"),this.linePath=this.area_series.append("path").datum(this.data[this.name]).attr("class",
this.id+" line").attr("stroke",this.opts.color).attr("fill","none").attr("stroke-linecap","round").attr("d",this.line).attr("stroke-width",2*this.opts.strokewidth),this.master_detail&&(this.md_root.select(".md-layers > .md_area_series").selectAll("."+this.id+".clipped").remove(),this.masterLinePath=this.md_root.select(".md-layers > .md_area_series").append("path").datum(this.data[this.name]).attr("class",this.id+" line").attr("stroke",this.opts.color).attr("fill","none").attr("stroke-linecap","round").attr("d",
this.master_line).attr("stroke-width",2*this.opts.strokewidth),this.masterLinePath.attr("clip-path","url(#"+this.rubix.master_id+"-clip)"),this.masterLinePath.classed("clipped",!0),this.masterAreaPath=this.md_root.select(".md-layers > .md_area_series").append("path").attr("class",this.id+" area").datum(this.data[this.name]).attr("d",this.master_area).attr("fill",this.opts.color).attr("fill-opacity",this.opts.fillopacity).attr("stroke","none"),this.masterAreaPath.attr("clip-path","url(#"+this.rubix.master_id+
"-clip)"),this.masterAreaPath.classed("clipped",!0),this.dataChanged&&(this.rubix.resetExtent(),this.dataChanged=!1),this.opts.noshadow||(this.strokePath1.attr("clip-path","url(#"+this.rubix.master_id+"-clip)"),this.strokePath2.attr("clip-path","url(#"+this.rubix.master_id+"-clip)"),this.strokePath3.attr("clip-path","url(#"+this.rubix.master_id+"-clip)")),this.linePath.attr("clip-path","url(#"+this.rubix.master_id+"-clip)"),this.opts.noshadow||(this.strokePath1.classed("clipped",!0),this.strokePath2.classed("clipped",
!0),this.strokePath3.classed("clipped",!0)),this.linePath.classed("clipped",!0),this.areaPath.classed("clipped",!0)),this.areaPath.attr("clip-path","url(#"+this.rubix.master_id+"-clip)"),this.setup=!0),this.rubix.resetFocus(a))};Rubix.AreaSeries.prototype.updatePoint=function(a,c,b){this.addPoint(a,c,b)};
Rubix.AreaSeries.prototype.removePoint=function(a,c){if(this.chart_hidden)this.temp_stack.push({type:"removePoint",ref:a});else{this.data[this.name]||(this.data[this.name]=[]);for(var b=0;b<this.data[this.name].length;b++)if(this.data[this.name][b].x===a){this.data[this.name].splice(b,1);break}this.master_detail&&(this.dataChanged=!0);c||(this.setup?this._animate_draw():(this.rubix.resetAxis(!0),this.rubix.forceRedraw()))}};
Rubix.AreaSeries.prototype.addPoint=function(a,c,b){this.rubix.data_changed=!0;if(!(a instanceof Object)||a instanceof Array)throw Error("Object required for addPoint");if(!a.hasOwnProperty("x")&&!a.hasOwnProperty("y"))throw Error("Object must be in the form: {x: ..., y: ...}");if(this.chart_hidden)this.temp_stack.push({type:"addPoint",data:a,shift:c});else{this.data[this.name]||(this.data[this.name]=[]);for(var d=!1,e=0;e<this.data[this.name].length;e++)if(this.data[this.name][e].x===a.x){this.data[this.name][e].y=
a.y;d=!0;break}d||this.data[this.name].push(a);this.data[this.name].sort(function(a,b){return a.x>b.x?1:a.x===b.x?0:-1});this.rubix.opts.interval?this.rubix.opts.interval<this.data[this.name].length&&this.data[this.name].shift():c&&this.data[this.name].shift();this.master_detail&&(this.dataChanged=!0);b||(this.setup?this._animate_draw():(this.rubix.resetAxis(!0),this.rubix.forceRedraw()))}};
...
this.opts.marker);}};Rubix.AreaSeries.prototype.on_focus=function(){this.setup&&this.linePath.attr("stroke-width",2*this.opts.strokewidth)};Rubix.AreaSeries.prototype.off_focus=function(){this.setup&&this.linePath.attr("stroke-width",2*this.opts.strokewidth)};
Rubix.Cleanup=function(){for(var a=null,c=0;c<RubixListeners.length;c++)a=RubixListeners[c],$(window).off("orientationchange."+a),$(window).off("rubix.redraw."+a),$(window).off("resize.rubix."+a),$(window).off("debouncedresize.rubix."+a),$(window).off("throttledresize.rubix."+a);RubixListeners=[]};
