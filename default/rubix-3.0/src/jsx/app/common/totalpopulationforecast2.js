...
var geos = ["rural_male","rural_female","rural_person","urban_male","urban_female","urban_person","urban_male","urban_female","urban_person"];
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                this.setState({tdata:opData[0],
                    data:getData(years,opData[1][0],"lpf"),
                    data1:getData(years,opData[1][1],"wp"),
                    data2:getData(years,opData[1][2],"ump"),
                    data3:getData(years,opData[1][3],"tp"),
            ...
            success: function (data) {
                if(fvalues.year <= data.totalpopulation[data.totalpopulation.length-1].year) {
                    ...
                    this.setState({
                        ...
                        data:getData(lchartData[4],lchartData[0],"lpf"),
                        data1:getData(lchartData[4],lchartData[1],"wp"),
                        data2:getData(lchartData[4],lchartData[2],"ump"),
                        data3:getData(lchartData[4],lchartData[3],"tp"),
                    });
                }
