...
class Body extends React.Component {
  ...
  notificationDirection(dir1, dir2) {
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td className='text-right'>
                                <Button outlined onClick={this.basicNotification.bind(this)}>
                                  Trigger basic
                                </Button>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td className='text-right'>
                                <Button bsStyle='info' outlined onClick={this.infoNotification.bind(this)}>
                                  Trigger info
                                </Button>{' '}
                                <Button bsStyle='danger' outlined onClick={this.errorNotification.bind(this)}>
                                  Trigger error
                                </Button>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td className='text-right'>
                                <Button bsStyle='success' outlined onClick={this.successNotification.bind(this)}>
                                  Trigger success
                                </Button>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td className='text-right'>
                                <Button bsStyle='darkgreen45' outlined onClick={this.updatingNotification.bind(this)}>
                            ...
                            <tr>
                              ...
                              <td className='text-right'>
                                <Button bsStyle='purple' outlined onClick={this.actionNotification.bind(this)}>
                                  Trigger launch
                                </Button>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td className='text-right'>
                                <Button bsStyle='desaturateddarkblue' outlined onClick={this.actionRetryNotification.bind(this)}>
                                  Make a choice Neo!
                                </Button>
                              </td>
                            </tr>
