...
import inputgetdomnode from '../snippets/inputgetdomnode.txt';
import inputgetchecked from '../snippets/inputgetchecked.txt';
import inputsetchecked from '../snippets/inputsetchecked.txt';
import inputgetvalue from '../snippets/inputgetvalue.txt';
