            ...
            <Col xs={12}>
              ...
              <div className='sidebar-nav-container'>
                <SidebarNav style={{marginBottom: 0}}>
                  ...
                  <SidebarNavItem glyph='devicon-rails-plain' name='Rails Installation' href='/app/docs/rails_installation' />
                  ...
                  <SidebarNavItem glyph='icon-fontello-looped-square-interest' name={<span>Rubix <BLabel className='bg-darkgreen45 fg-white'>2</BLabel></span>}>
                    <SidebarNav>
                      <SidebarNavItem name='Rubix - JSX' href='/app/docs/rubix/jsx' />
                      <SidebarNavItem name='Rubix - SASS' href='/app/docs/rubix/sass' />
                    </SidebarNav>
                  </SidebarNavItem>
