if (typeof window !== "undefined") {
  window.__ReactStyle__ = {"appStyleDIFFERENT_a":1,"masterStyle_b":2,"detailStyle_c":3};
}
if (typeof window !== "undefined") {
  window.__ReactStyle__ = {"appStyleDIFFERENT_a":1,"masterStyle_b":2,"detailStyle_c":3};
}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({displayName: "App",
	  ...
	  render: function () {
	    ...
	    return (
	      React.createElement("div", {styles: AppStyles.appStyle__DIFFERENT}, 
	        React.createElement("ul", {styles: AppStyles.masterStyle}, 
	          links
	        ), 
	        React.createElement("div", {styles: AppStyles.detailStyle}, 
